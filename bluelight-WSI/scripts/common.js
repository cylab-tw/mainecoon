...
function PictureOnclick(alt) {
    ...
    for (var l = 0; l < Patient.Study[i].Series[j].SopAmount; l++) {
        var instance=Patient.Study[i].Series[j].Sop[l];
        for (var f = 0; f < instance.FrameAmount; f++) {
           // console.log("222",instance.Frames[f].imageId);
            loadAndViejpeg(instance.Frames[f].imageId,undefined,undefined,undefined,instance.response,instance.Frames[f].frame);
        }
        /*
